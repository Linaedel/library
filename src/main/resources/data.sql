...
('person', 4, 'U1', '1', 0, 'Андрей', 0, 'Москва', '223322', null),
('person', 5, 'U2', '2', 0, 'Сергей', 0, 'Урюпинск', '123321', null),
('person', 6, 'Admin', 'admin', 0, 'Admin', 0, 'Торонто', '01', null),
('person', 7, 'L', 'l', 0, 'Варфоломей', 0, 'Бобруйск', '555', null)
;
...
(1, 1222, 'Сто лет одиночества', 'Г.Г. Маркес', 3, 0),
